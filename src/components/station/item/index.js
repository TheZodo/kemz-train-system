...
function Item({name,description , _id, onDelete, isGray, loading}) {
    ...
    return (
        <div>
            ...
            <Wrapper isGray={isGray}
                tailwind={`grid grid-cols-3  py-4 px-2 lg:px-6 items-center juustify-center `}>
                <DataText
                >  {name}</DataText>
                <DataText
                    tailwind=' mr-8'     > {description} </DataText>
